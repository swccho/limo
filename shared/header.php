        ...
        <div class="owl-carousel header_carousel">
            ...
            <div class="image2 item">
                ...
                <div class="info container">
                        ...
                        <p class="text-light">Grow Your Revenue Through Passenger Mobile Apps & Online Reservation Systems</p>
                        <button class="btn ">Read More</button>
                </div>
            ...
            <div class="image3 item">
                ...
                <div class="info container">
                        ...
                        <p class="text-light">Become Part Of The Largest Ground Transportation Network In The World</p>
                        <button class="btn ">Read More</button>
                </div>
            ...
            <div class="image4 item">
                ...
                <div class="info container">
                        ...
                        <p class="text-light">State-Of-The-Art Website CMS And Templates. Give Your Business A Professional Look And User Experience</p>
                        <button class="btn ">Read More</button>
                </div>
